/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 40ff8cbdedb23708542792f97ed7b773)
// Runtime types generated with workerd@1.20260430.1 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		PUBLIC_GA_ID: "G-VQHSG13N84";
		ADMIN_EMAIL: string;
		AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_GA_ID" | "ADMIN_EMAIL" | "AUTH_SECRET" | "AUTH_TRUST_HOST" | "AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
